...
public class MenuItemServiceImpl implements MenuItemService {
	...
	public ResponseEntity<MenuItem> addMenuItem(int restaurantId, MenuItemDto menuItemDto) {
		...
		if (menuItemDto.getDescription() == null || menuItemDto.getDescription().trim().isEmpty()) {
...
//		}
	...
	public List<MenuResponse> getRestaurantMenu(int restaurantId) {
		...
		Map<String, List<MenuItemResponse>> groupedMenu = new LinkedHashMap<String, List<MenuItemResponse>>();
		...
		for (MenuItem menuItem : menuItems) {
			...
			//Category categoryObj = categoryrepo.findById(menuItem.getCategory()).get();
