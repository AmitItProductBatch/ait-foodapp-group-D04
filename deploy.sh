...
echo -e "${GREEN}======================================================${NC}"
echo -e "👉 ${CYAN}Frontend UI       :${NC} http://localhost:4004"
echo -e "👉 ${CYAN}Backend REST API  :${NC} http://localhost:8084/api/users"
echo -e "👉 ${CYAN}PostgreSQL DB     :${NC} localhost:5004 (DB: fooddelivery)"
echo -e "${GREEN}======================================================${NC}"
