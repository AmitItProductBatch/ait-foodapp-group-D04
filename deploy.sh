...
echo -e "${GREEN}======================================================${NC}"
echo -e "👉 ${CYAN}Frontend UI       :${NC} http://${SERVER_IP:-194.242.57.93}:4004"
echo -e "👉 ${CYAN}Backend REST API  :${NC} http://${SERVER_IP:-194.242.57.93}:8084/api/users"
echo -e "👉 ${CYAN}PostgreSQL DB     :${NC} ${SERVER_IP:-194.242.57.93}:5004 (DB: fooddelivery04)"
echo -e "${GREEN}======================================================${NC}"
